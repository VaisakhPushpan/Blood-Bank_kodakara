export const translations = {
  ml: {
    ...
    form: {
      ...
      medicalConditions: "എന്തെങ്കിലും അസുഖങ്ങൾ ഉണ്ടോ? (Any Medical Conditions?)",
      yes: "ഉണ്ട് (Yes)",
      no: "ഇല്ല (No)",
      phone: "ഫോൺ നമ്പർ",
    ...
    urgentAlerts: {
      title: "അടിയന്തിര ആവശ്യങ്ങൾ",
      bloodGroup: "രക്തഗ്രൂപ്പ്",
      hospital: "ആശുപത്രി",
      contact: "ബന്ധപ്പെടുക",
      posted: "നൽകിയത്",
      noAlerts: "നിലവിൽ അടിയന്തിര ആവശ്യങ്ങൾ ഇല്ല.",
    },
    history: {
      title: "രക്തദാന ചരിത്രം",
      addBtn: "ചേർക്കുക",
      date: "തീയതി",
      hospital: "ആശുപത്രി / സ്ഥലം",
      noHistory: "ചരിത്രം ലഭ്യമല്ല.",
      success: "വിജയകരമായി ചേർത്തു!",
    },
    admin: {
      title: "അഡ്മിൻ ഡാഷ്ബോർഡ്",
      manageAlerts: "അടിയന്തിര ആവശ്യങ്ങൾ നിയന്ത്രിക്കുക",
      addAlert: "പുതിയ ആവശ്യം ചേർക്കുക",
      donorStats: "ദാതാക്കളുടെ കണക്കുകൾ",
      totalDonors: "ആകെ ദാതാക്കൾ",
      availableDonors: "ലഭ്യമായവർ",
      unavailableDonors: "ലഭ്യമല്ലാത്തവർ",
      donorList: "ദാതാക്കളുടെ പട്ടിക",
      group: "ഗ്രൂപ്പ്",
      count: "എണ്ണം",
      deleteAlert: "ഒഴിവാക്കുക",
      alertSuccess: "അലർട്ട് വിജയകരമായി ചേർത്തു!",
      searchPlaceholder: "പേര് അല്ലെങ്കിൽ സ്ഥലം ഉപയോഗിച്ച് തിരയുക",
      viewDetails: "വിശദാംശങ്ങൾ",
      medicalReason: "ആരോഗ്യപരമായ കാരണങ്ങൾ",
      cooldownReason: "വിശ്രമ കാലയളവ്",
    },
    common: {
  ...
  en: {
    ...
    urgentAlerts: {
      ...
      contact: "Contact",
      posted: "Posted",
      noAlerts: "No urgent requirements at the moment.",
    },
    history: {
    ...
    admin: {
      ...
      manageAlerts: "Manage Urgent Needs",
      addAlert: "Add New Requirement",
      donorStats: "Donor Statistics",
      ...
      count: "Count",
      deleteAlert: "Delete",
      alertSuccess: "Alert added successfully!",
      searchPlaceholder: "Search by name or location",
      viewDetails: "View Details",
      medicalReason: "Medical Reason",
      cooldownReason: "Cooldown Period",
    },
    common: {
      loading: "Loading...",
